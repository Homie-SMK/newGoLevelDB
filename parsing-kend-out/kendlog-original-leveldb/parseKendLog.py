...
outFileName = logFileName + ".parsed"
...
with open(logFileName, 'r', encoding='utf-8') as infile:
    ...
    with open(outFileName, 'w', encoding='utf-8') as outfile:
        for line in infile:
            isCase = False
            if "table-compaction-start" in line: # example line: "Compaction start sourceLevel 1 statetrie/2"
                isCase = True
                compactionFlag = 1
            ...
            if "table-compaction-ended" in line: # example line: "Compaction end sourceLevel 1 statetrie/2"
                isCase = True
                compactionFlag = 0
                sourceLevel = "-1" # back to default

            if "get-elapsed" in line: # example line: "SMIN Gettime 11.123 statetrie/2"
                isCase = True
                splitLine = line.split(" ")
                # print(splitLine)
