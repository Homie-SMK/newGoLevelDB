...
print("count of get done per each section")
print("no compaction :: ", cnt_no_compaction)
print("normal :: ", cnt_normal)
print("total count :: ", cnt_no_compaction + cnt_normal)

total_get_latency = total_get_latency_no_compaction + total_get_latency_normal

print("total get delay (ms) :: ", total_get_latency)
...
pio.write_image(fig, './original_get_latency_boxplot_2.jpeg',scale=6, width=700, height=370)
"""