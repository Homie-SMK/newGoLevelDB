...
bp = ax.boxplot([no_comp_gets, single_comp_gets, concurrent_comp_gets, total_gets], labels=['NoCompaction', 'Single', 'Concurrent', 'Total'])

# Add labels and title
ax.set_xlabel('SECTION')
ax.set_ylabel('GET LATENCY (MS)')
ax.set_title('NEW LEVELDB')
...
# Show the plot
plt.savefig('new_get_latency_boxplot.png')