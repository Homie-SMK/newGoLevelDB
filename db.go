...
func openDB(s *session) (*DB, error) {
	//SM
	//fmt.Println("SM:db_path@", reflect.ValueOf(s.stor.Storage).Elem().Field(0), ": openDB entered: /leveldb/db.go")
	s.logf("SM:db_path@%s: openDB entered: /leveldb/db.go", reflect.ValueOf(s.stor.Storage).Elem().Field(0))
...
func Open(stor storage.Storage, o *opt.Options) (db *DB, err error) {
	//SM
	//fmt.Println("SM: ", reflect.ValueOf(stor).Elem().Field(0), "Open entered: /leveldb/db.go")
...
func OpenFile(path string, o *opt.Options) (db *DB, err error) {
	...
	//SM
	//fmt.Println("SM: entered OpenFile:")
	return
}
